...
// Tour BOOKING form — for customers who have decided on a tour and want to
// confirm it. After the details are filled in, they go through the advance
// payment step (UPI) to lock their dates. For a no-commitment WhatsApp enquiry,
// use BookingForm instead.
